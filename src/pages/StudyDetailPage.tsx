import { CheckCircle, Settings, UserCheck, Users, UsersIcon, X } from "lucide-react"
...
실제 데이터셋을 다루며 데이터 전처리, 시각화, 통계 분석, 간단한 머신러닝까지 경험할 수 있습니다.`,
    ...
    requirements: ["Python 기초 문법 이해", "데이터 분석에 관심 있는 분", "노트북 지참 가능자"],
    ownerId: "user125",
  },
  4: {
    id: 4,
...
실제 앱을 기획하고 개발하며, 퍼블리싱까지 경험할 수 있습니다.`,
    ...
    requirements: ["Dart/Flutter 개발 경험", "모바일 앱 개발에 관심 있는 분", "팀 프로젝트 경험자 우대"],
    ownerId: "user126",
  },
}
          ...
          <CardHeader>
            <div className="flex flex-col items-start justify-between gap-4 md:flex-row">
                ...
                {isOwner && (
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => onManageAttendance?.(studyId)}
              ...
              {userApplicationStatus === "approved" && !isOwner && (
                <div className="w-full shrink-0 border-t border-gray-200 pt-4 md:w-auto md:border-t-0 md:border-l md:pl-4">
                  <div className="flex items-end gap-2">
                    <div className="grid w-full max-w-sm items-center gap-1.5">
                      <Label htmlFor="attendance-code" className="text-sm font-medium">
                        출석코드
                      </Label>
                      <Input type="text" id="attendance-code" placeholder="코드를 입력하세요" className="h-9" />
                    </div>
            ...
            <Card className="border-gray-200">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-gray-700">{study.manager}</p>
                </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  {userApplicationStatus === "approved" && (
                    <div className="space-y-4">
                      <div className="text-center">
                        <p className="mb-2 font-medium text-green-600">스터디에 참여 중입니다!</p>
                      </div>
                      <Separator className="bg-gray-200" />
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                  ...
                  {!userApplicationStatus &&
                    (study.recruitmentMethod === "지원서" ? (
                      <>
                        <p className="mb-2 text-center text-gray-500 text-xs">지원 동기 및 각오를 작성해주세요</p>
                        <Button
                        ...
                        <AlertDialog open={isApplicationModalOpen} onOpenChange={setIsApplicationModalOpen}>
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>지원 동기 및 각오를 작성해주세요.</AlertDialogDescription>
                            </AlertDialogHeader>
                            <Textarea
                              id="application"
